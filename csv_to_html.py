...
htmlfile.write('<meta HTTP-EQUIV="pragma" CONTENT="no-cache">')
htmlfile.write('<meta HTTP-EQUIV="Cache-Control" CONTENT="no-cache, must-revalidate">')
htmlfile.write('<meta HTTP-EQUIV="expires" CONTENT="0">')

htmlfile.write('<link type="text/css" rel="styleSheet"  href="mystyle.css" />')

# write <table> tag
htmlfile.write('<table class="table9_4">')
